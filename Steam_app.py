...
with col1:
   ...
   categories_select = categories_count[categories_count.year.isin(select_year)].sort_values('category',ascending=False)
   #plot
...
steam_recommend = steam_recommend.sort_values('name', ascending=True)
