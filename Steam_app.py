...
platforms_count = pd.read_csv('/home/juliana/Documents/DS_Allwomen/_Final_project_dataset/platforms_count.csv')
# Split genre dataset:
genres_count = pd.read_csv('/home/juliana/Documents/DS_Allwomen/_Final_project_dataset/genres_count.csv')
# Split categories dataset:
categories_count = pd.read_csv('/home/juliana/Documents/DS_Allwomen/_Final_project_dataset/categories_count.csv')
# Split languages dataset:
languages_count = pd.read_csv('/home/juliana/Documents/DS_Allwomen/_Final_project_dataset/languages_count.csv')
